...
router.post(
  ...
  adminProductController.activateProduct,
); // activate product
router.post(
  "/products/deactivate/:productid",
  adminProductController.deactivateProduct,
); // deactivate product
router
  .route("/products/add")
  .get(adminProductController.getAddProduct) // get add product page
  .post(
    adminProductController.productUpload.array("mainImages", 4),
...
router.post(
  "/categories/hide/:categoryid",
  adminCategoryController.hideCategory,
); // hide category
router.post(
  "/categories/unhide/:categoryid",
  adminCategoryController.unhideCategory,
); // unhide category
...
router.post(
  "/orders/:orderId/items/:itemId/update-status",
  adminOrderController.updateOrderItemStatus,
...
router.patch(
  ...
  adminCouponsController.toggleCouponStatus,
...
router.patch(
  ...
  adminOfferController.toggleOfferStatus,
); // toggle offer status
...
router.post(
  "/customers/block/:customerid",
  adminCustomersController.blockCustomer,
); // block customer
router.post(
  "/customers/unblock/:customerid",
  adminCustomersController.unblockCustomer,
); // unblock customer
