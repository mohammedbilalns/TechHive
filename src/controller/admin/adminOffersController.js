...
const addOffer = async (req, res) => {
    try {
        ...
        res.status(HttpStatus.INTERNAL_SERVER_ERROR).json({ success: false, message: 'Failed to add offer' });
    }
};
...
const updateOffer = async (req, res) => {
    try {
        ...
        res.status(HttpStatus.INTERNAL_SERVER_ERROR).json({ success: false, message: 'Failed to update offer' });
    }
};
...
const toggleOfferStatus = async (req, res) => {
    try {
		...
		res.status(HttpStatus.INTERNAL_SERVER_ERROR).json({ success: false, message: 'Failed to toggle offer status' });
    }
};
...
const deleteOffer = async (req, res) => {
    try {
		...
		res.status(HttpStatus.INTERNAL_SERVER_ERROR).json({ success: false, message: 'Failed to delete offer' });
    }
};
