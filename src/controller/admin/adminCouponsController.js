...
const getCoupons = async (req, res) => {
    try {
        ...
        res.status(HttpStatus.INTERNAL_SERVER_ERROR).json({ success: false, message: 'Failed to fetch coupons' });
    }
};
...
const getCouponDetails = async (req, res) => {
    try {
        ...
        res.status(HttpStatus.INTERNAL_SERVER_ERROR).json({ success: false, message: 'Failed to fetch coupon details' });
    }
};
...
const toggleCouponStatus = async (req, res) => {
    try {
        ...
        res.status(HttpStatus.INTERNAL_SERVER_ERROR).json({ success: false, message: 'Failed to update coupon status' });
    }
};
...
const deleteCoupon = async (req, res) => {
    try {
        ...
        res.status(HttpStatus.INTERNAL_SERVER_ERROR).json({ success: false, message: 'Failed to delete coupon' });
    }
};
